...
Camera::update(float time){
	float xP,yP,xB,yB,z;
	xP = physicWorld->getPlayer(1)->getPosition().X;
	yP = physicWorld->getPlayer(1)->getPosition().Y;
	xB = physicWorld->getPlayer(2)->getPosition().X;
	yB = physicWorld->getPlayer(2)->getPosition().Y;
