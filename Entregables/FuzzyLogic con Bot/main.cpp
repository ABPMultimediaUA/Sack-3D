...
int main(){
    ...
    Player* player = new Player(vector3df(100,0,0));
    Bot* bot1  = new Bot(vector3df(-280,-20,0));
    //CREACION DE ARMAS//

    Arma* arma = new Arma(vector3df(100,-20,0));
    Escopeta* escopeta = new Escopeta(vector3df(120,-60,0));
