...
Player* PhysicWorld::getObjetivo(){return objetivo;}
Map* PhysicWorld::getMapa(){return mapa;}
b2World* PhysicWorld::GetWorld(){return world;}
void PhysicWorld::setPlayers(Player* c, Player* o){jugador1 = c; objetivo = o;}
void PhysicWorld::setMapa(Map* map){mapa = map;}
//---------------------------------------------------------------------------
/**
   Destructor
*/
